...
if __name__ == '__main__':
    ...
    x = torch.arange(5 * 4 * 3).view(5, 4, 3)
    print(drop_path(x, dim=0, drop_prob=0.3, training=True,scale_by_keep=False))
    print(drop_path(x, dim=1, drop_prob=0.3, training=True,scale_by_keep=False))
