...
class PixelSequenceDataset(FairseqDataset):
    ...
    def __init__(self, path, normalization, reverse_order=False, dataset_percentage=1.0):
    ...
    def read_data(self, path):
        ...
        self.tokens_list = self.tokens_list[:int(self.dataset_percentage * len(self.tokens_list))]
