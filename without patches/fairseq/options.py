...
def add_two_d_ssm_args(parser):
    ...
    group.add_argument('--use_positional_encoding', type=bool, default=False, help='Use complex ssm')

    group.add_argument('--directions_amount', type=int, default=4, help='number directions, can be 2 or 4')
    group.add_argument('--save_kernels_and_exit', type=bool, default=False, help='Should')
    group.add_argument('--ema_type', type=str, default='ema', help='Should')
    group.add_argument('--s4nd_config', type=str, default=r'', help='Should')
    group.add_argument('--dataset_percentage', type=float, default=1.0, help='Should')
